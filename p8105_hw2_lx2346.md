...
**The trash_df has 845 rows and 19 columns. It is a 845✖15 table.**  
There are 845 observations. The variables in the dataset are dumpster,
...
The total weight of trash Professor Trash Wheel collect is 216.26 tons.
...
```
    ...
    ##  1 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  2 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  3 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  4 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  5 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  6 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  7 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  8 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ##  9 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ## 10 Ali Imdad       Ali                     25 Charity worker   Saltley, …      4
    ## # ℹ 1,126 more rows
